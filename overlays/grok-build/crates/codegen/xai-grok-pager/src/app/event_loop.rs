...
pub(crate) struct RunResult {
    ...
    /// Access-point login handoff: host should run `sisu login` and respawn.
...
pub(crate) async fn run(
    ...
    if let Some(meta) = connection.auth_meta.as_ref() {
        ...
        app.is_api_key_auth = if xai_grok_shell::sisu_access_point::active() {
            false
        } else {
...
fn finish_run(app: &mut AppView) -> RunResult {
    ...
    RunResult {
        ...
        quit_for_sisu_login: app.quit_for_sisu_login,
